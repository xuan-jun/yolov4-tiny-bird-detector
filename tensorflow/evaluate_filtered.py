...
def main(_argv):
    ...
    with open(cfg.TEST.ANNOT_PATH, 'r') as annotation_file:
        for num, line in enumerate(annotation_file):
            ...
            first_model = "./checkpoints/yolov4-first-416"
            ...
            first_model = tf.saved_model.load(first_model, tags=[tag_constants.SERVING])
            ...
            if temp_valid_detections[0] != 0:
                saved_model_loaded = tf.saved_model.load(weights[class_num], tags=[tag_constants.SERVING])
